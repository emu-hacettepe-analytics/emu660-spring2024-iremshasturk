...
(C:\Users\irems\Documents\GitHub\emu660-spring2024-iremshasturk\assets\images/sustainable-energy.webp)
```
...
```{r}
ggplot(co2_emissions, aes(x=Year, y=emission, color=month)) + geom_line()
