...
annual_data_from2015to2020_prophet2 <- annual_data_from2015to2020 %>%
  select(Year, Total) %>%
  filter(Year >= 2015)%>% 
  rename(ds = Year, y = Total)

# Prophet modelini eğitme
prophet_model2 <- prophet(annual_data_from2015to2020_prophet2)

# Modeli eğitmek için veri aralığını belirleme
start_date <- min(annual_data_from2015to2020_prophet2$ds)
end_date <- 2022
